...
DEFAULT_BOXSYNC_DATA_PATH = unicodedata.normalize('NFC', os.path.expanduser(
    u'~/.noiselabs/%s' % BOXSYNC.lower()))

# Databases
DEFAULT_CONFIG_DB_PATH = os.path.join(DEFAULT_BOXSYNC_DATA_PATH, 'config.db')

# Log file
DEFAULT_LOG_PATH = os.path.join(DEFAULT_BOXSYNC_DATA_PATH, '%s.log' %
   BOXSYNCD_BIN)
